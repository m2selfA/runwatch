...
- the next pi-runs acceptance revision must shorten Local path transcription while preserving strict normalized workdir/command equality; only then may a new frozen formal authority start. All dirty authorities remain immutable and uncredited.
