...
- continue only authority #5 until `v1_endurance.qualified=true`; it still needs a second natural settlement-crash recovery and enough clean active time to reach 7200 s. Earlier authorities remain preserved and do not count.
