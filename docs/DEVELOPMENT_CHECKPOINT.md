...
- [ ] Continue only authority #10 until machine `v1_endurance.qualified=true`. Segment 3 is running with an 1800-second per-segment budget to sweep rounds 3–5 under the same frozen contract. Authority #7 remains historical qualification; #8/#9 remain immutable failed evidence.
