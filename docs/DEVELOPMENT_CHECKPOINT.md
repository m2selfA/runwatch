...
- [ ] Continue only authority #11 until machine `v1_endurance.qualified=true`; segment 1 uses a 2400-second budget under the unchanged target7200 / Local+Slurm / delay600 / seed480 / restart1 / rebind2 / settlement3 / SSH2×8s contract. Authority #7 remains historical qualification; #8/#9/#10 remain immutable failed evidence.
