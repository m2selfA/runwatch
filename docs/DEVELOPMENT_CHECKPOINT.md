...
- [ ] Continue only authority #11 until machine `v1_endurance.qualified=true`; round 6 is the next scheduled completion-before-settlement crash recovery. Authority #7 remains historical qualification; #8/#9/#10 remain immutable failed evidence.
