...
- [ ] Keep authority #6's pi-runs runtime/acceptance tree frozen and continue only this authority until `v1_endurance.qualified=true`; docs/checkpoint synchronization remains permitted.
