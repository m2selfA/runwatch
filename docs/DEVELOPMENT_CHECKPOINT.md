...
- [ ] Run the final RC replay now that the blocker is closed: runwatch fmt/check/test, pi-runs npm/loader/live bridge, packaged doctor, real-provider Local + gm00 Slurm gates, package verify and final endurance audit. Authority #7 remains historical qualification; #8/#9/#10 remain immutable failed evidence.
