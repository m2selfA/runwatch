...
- [ ] Freeze the corrected pi-runs verifier tree and start a new formal authority from that hash. All dirty authorities remain immutable/non-resumable and contribute no duration.
