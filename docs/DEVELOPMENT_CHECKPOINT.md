...
- [ ] Start a new frozen formal endurance authority from pi-runs `bcc9eaf` and continue until `v1_endurance.qualified=true`; all failed authorities remain immutable/non-resumable.
