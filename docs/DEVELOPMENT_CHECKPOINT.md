...
- [ ] Keep authority #5's active pi-runs runtime/acceptance contract frozen and resume only this authority until `v1_endurance.qualified=true`; docs/checkpoint synchronization remains permitted.
