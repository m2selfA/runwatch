...
- [ ] Continue only authority #7 under its unchanged frozen tree until clean active time reaches 7200 s. At **4453.440 s**, the sole remaining `v1_endurance` failure reason is `active_time_meets_target`; do not change product or acceptance code while this authority remains clean.
