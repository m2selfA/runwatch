...
- [ ] Continue authority #9 across clean segments until machine `v1_endurance.qualified=true`; authority #7 remains immutable historical qualification and #8 remains immutable failed evidence.
