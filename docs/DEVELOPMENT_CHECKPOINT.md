...
- [ ] Start the final formal authority from this cleanup-fixed pi-runs tree, freeze its active runtime/acceptance contract, and resume only that authority until `v1_endurance.qualified=true`.
