...
- [ ] Continue only authority #11 until machine `v1_endurance.qualified=true`; keep packaged runwatch `f6b75b8` and the frozen fault contract unchanged. Authority #7 remains historical qualification; #8/#9/#10 remain immutable failed evidence.
