...
- [ ] Keep authority #6's pi-runs runtime/acceptance tree frozen and resume only this authority. Segment 2 should naturally reach the second SSH/rebind recoveries at round 4 and second settlement-crash recovery at round 6; continue resumable clean segments until `v1_endurance.qualified=true`.
