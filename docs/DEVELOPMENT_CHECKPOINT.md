...
- [ ] Resume only authority #9 until machine `v1_endurance.qualified=true`; round 2 carries the first scheduled SSH-loss + branch-rebind pair. Authority #7 remains immutable historical qualification and #8 remains immutable failed evidence.
