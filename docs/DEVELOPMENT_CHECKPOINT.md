...
- [ ] Keep authority #8 runtime/acceptance tree frozen and resume only this authority across clean segments until machine `v1_endurance.qualified=true`; authority #7 remains immutable historical evidence.
