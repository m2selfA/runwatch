...
- [ ] Continue only authority #10 until machine `v1_endurance.qualified=true`. Only active elapsed **3550.507 < 7200 s** and repeated settlement-crash recovery remain; round 6 is the next scheduled settlement-crash round. Authority #7 remains historical qualification; #8/#9 remain immutable failed evidence.
