...
- [ ] Resume authority #7 under its unchanged frozen contract; round 4 should provide the second SSH/rebind pair and round 6 the second settlement-crash recovery. Continue only this authority until read-only `v1_endurance.qualified=true`.
