...
- [ ] Resume only authority #10 until machine `v1_endurance.qualified=true`. Segment 2 / round 2 is active on Local `local:101792:01dd3b8db903bdbc` + gm00 Job **31814**; serve **102816 -> 103536** and real SSH `fresh -> unreachable(Channel send error) -> unreachable(os error 10054) -> fresh` have already occurred, with Local branch divergence armed. Authority #7 remains historical qualification; #8/#9 remain immutable failed evidence.
