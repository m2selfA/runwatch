...
- [ ] Start fresh authority #10 from pi-runs `7d7755e` against unchanged packaged runwatch `f6b75b8`; never resume #9. Continue only #10 until machine `v1_endurance.qualified=true`. Authority #7 remains historical qualification; #8/#9 remain immutable failed evidence.
