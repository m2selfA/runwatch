...
- [ ] Keep authority #7 frozen. Round 3 is active for the first completion-before-settlement crash recovery; continue only this authority until read-only `v1_endurance.qualified=true`.
