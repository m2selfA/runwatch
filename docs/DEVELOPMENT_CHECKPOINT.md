...
- [ ] Start a fresh fixed-binary formal endurance authority using the verified `f6b75b8` package and unchanged 7200-second mixed-fault contract; authority #7 remains immutable historical evidence and is not retroactively reclassified.
